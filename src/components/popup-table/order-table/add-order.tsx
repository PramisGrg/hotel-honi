import RenderRoom from "@/components/order/render-room";
import { RenderTable } from "@/components/order/render-table";
            ...
            <div className="py-4">
              <button
                ...
                className={`px-8 py-2 rounded-md ${
                  showTable ? "bg-primary text-white " : "bg-white text-black"
                }`}
              >
                Table
              </button>
              <button
                ...
                className={`px-8 py-2 rounded-md ${
                  showTable ? "bg-none" : "bg-primary text-white"
                }`}
              >
                Room
              </button>
